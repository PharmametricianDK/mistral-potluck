 ...
 * Single file solution with embedded HTML and JavaScript
 */
...
// Using a function to generate the HTML to avoid template literal issues
...
// Default items - these will be loaded from the Worker
const DEFAULT_ITEMS = [
    "Forret: Brød med dip",
    "Forret: Frikadeller",
    "Forret: Røget laks",
...
function renderItems() {
    ...
    availableItems.forEach(item => {
        const checked = selectedItemId === item.id ? 'checked' : '';
        html += '<div class="item" data-id="' + item.id + '" onclick="selectItem(\'' + item.id + '\')">';
        html += '<input type="radio" name="item" id="radio_' + item.id + '" ' + checked + '>';
        html += '<span class="item-label">' + escapeHtml(item.name) + '</span>';
        html += '</div>';
    });
    availableItemsEl.innerHTML = html;
    ...
    reservedItems.forEach(({ item, reservation }) => {
        html += '<div class="item reserved" data-id="' + item.id + '">';
        html += '<input type="radio" name="item" id="radio_' + item.id + '" disabled>';
        html += '<span class="item-label">' + escapeHtml(item.name) + '</span>';
        html += '<span class="reserved-by">Reserveret af: ' + escapeHtml(reservation.name) + '</span>';
        html += '</div>';
    });
    reservedItemsEl.innerHTML = html;
